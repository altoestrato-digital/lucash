...
export default function BalancePeriodoCard({
  ...
  const balanceUsdNum = Number(balanceMesUsd);
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-xl border border-zinc-200 dark:border-zinc-700 overflow-hidden">
            ...
            <div className="p-3 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400">{formatUsd(ingresoMesUsd)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-[10px] uppercase tracking-wider text-rose-600 dark:text-rose-400">Egresos</span>
                <span className="text-sm font-bold text-rose-600 dark:text-rose-400">{formatUsd(gastadoMesUsd)}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`text-sm font-bold ${balanceUsdNum >= 0 ? "text-blue-600 dark:text-blue-400" : "text-amber-600 dark:text-amber-400"}`}>{formatUsd(balanceMesUsd)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-zinc-200 dark:border-zinc-700 overflow-hidden">
            ...
            <div className="p-3 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-[10px] uppercase tracking-wider text-emerald-600 dark:text-emerald-400">Ingresos</span>
                <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400">{formatBs(ingresoMesBs)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-[10px] uppercase tracking-wider text-rose-600 dark:text-rose-400">Egresos</span>
                <span className="text-sm font-bold text-rose-600 dark:text-rose-400">{formatBs(gastadoMesBs)}</span>
              </div>
              <div className="h-px bg-zinc-200 dark:bg-zinc-700" />
              <div className="flex items-center justify-between">
                ...
                <span className={`text-sm font-bold ${balanceBsNum >= 0 ? "text-blue-600 dark:text-blue-400" : "text-amber-600 dark:text-amber-400"}`}>{formatBs(balanceMesBs)}</span>
              </div>
            </div>
          </div>
        </div>
